...
The goal of regexcitesg is to make regular expressions more exciting!
...
You can install the development version of regexcitesg from [GitHub](https://github.com/) with:
